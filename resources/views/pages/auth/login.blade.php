    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm lg:w-96">
      ...
      <form class="space-y-6" action="{{ route('auth') }}" method="POST">
        ...
        <div>
          ...
          <div class="mt-2">
            <input id="email" name="email" value="{{ old('email') }}" type="email" autocomplete="off" placeholder="Email" class="block w-full rounded-md border-1 @error('email') border-red-600 focus:ring-red-600 @enderror  py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6">
          </div>
          @error('email')
        ...
        <div>
          ...
          <div class="mt-2">
            <input id="password" value="{{ old('password') }}"  name="password" type="password" placeholder="Senha" autocomplete="off" class="block w-full rounded-md border-1 @error('password') border-red-600 focus:ring-red-600 @enderror py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6">
          </div>
